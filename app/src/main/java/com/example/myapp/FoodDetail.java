...
public class FoodDetail extends AppCompatActivity implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRating=(CounterFab) findViewById(R.id.btn_rating);
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FoodDetail.this,"Thêm vào Giở hàng",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if(getIntent()!=null)
            ...
            if(!foodId.isEmpty())
            {
                ...
                {
                    Toast.makeText(FoodDetail.this,"Sự cố, Kiểm tra lại đường truyền!",Toast.LENGTH_SHORT).show();
                    return;
                }
            }
    ...
    private void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .setNoteDescriptions(Arrays.asList("Rất Tệ","Tệ","Bình thường","Ngon","Tuyệt Hảo"))
                .setDefaultRating(1)
                .setTitle("Đánh giá món ăn này!")
                .setDescription("Hãy chọn một mức điểm và cho chúng tôi biết cảm nhận của bạn về món ăn này")
                .setTitleTextColor(R.color.colorPrimary)
                .setDescriptionTextColor(R.color.colorPrimary)
                .setHint("Viết lời đánh giá của bạn ở đây...")
